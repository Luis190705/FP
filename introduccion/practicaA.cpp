...
int main() {
    ...
    cout << "1. Rango INT : " << numeric_limits<int>::min() << " a " << numeric_limits<int>::max() << endl;
    ...
    cout << "3. Rango largo largo : " << numeric_limits<long long>::min() << " a " << numeric_limits<long long>::max() << endl;
    ...
    cout << "9. Rango largo con signo : " << numeric_limits<signed long long>::min() << " a " << numeric_limits<signed long long>::max() << endl;
    ...
    cout << "10. Rango largo largo : " << numeric_limits<long long int>::min() << " a " << numeric_limits<long long int>::max() << endl;
